...
class LocalNegativesSampler(NegativesSampler):
    def __init__(
        ...
        l2_norm: bool,
        l2_norm_eps: float,
        local_emb_module: torch.nn.Module = None
    ) -> None:
        ...
        self.local_emb_module = local_emb_module
    ...
    def forward(
        ...
        out = self.local_emb_module.get_item_embeddings(sampled_ids)
        return sampled_ids, self.normalize_embeddings(out) # self._item_emb(sampled_ids)) 
